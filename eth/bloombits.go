...
const (
	// bloomServiceThreads is the number of goroutines used globally by an Genom
...
func (eth *Genom) startBloomHandlers(sectionSize uint64) {
...
// for the Genom header bloom filters, permitting blazing fast filtering.
