...
// PublicEthereumAPI provides an API to access Genom related information.
// It offers only methods that operate on public data that is freely available to anyone.
type PublicEthereumAPI struct {
	b Backend
}

// NewPublicEthereumAPI creates a new Genom protocol API.
...
// ProtocolVersion returns the current Genom protocol version this node supports
...
// Sign calculates an Genom ECDSA signature for:
...
func (s *PrivateAccountAPI) EcRecover(ctx context.Context, data, sig hexutil.Bytes) (common.Address, error) {
	...
	if sig[64] != 27 && sig[64] != 28 {
		return common.Address{}, fmt.Errorf("invalid Genom signature (V is not 27 or 28)")
	}
...
// PublicBlockChainAPI provides an API to access the Genom blockchain.
// It offers only methods that operate on public data that is freely available to anyone.
type PublicBlockChainAPI struct {
	b Backend
}

// NewPublicBlockChainAPI creates a new Genom blockchain API.
...
// PublicDebugAPI is the collection of Genom APIs exposed over the public
// debugging endpoint.
...
// PrivateDebugAPI is the collection of Genom APIs exposed over the private
// debugging endpoint.
