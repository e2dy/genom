...
// DeployChequebook deploys a new Genom contract, binding an instance of Chequebook to it.
...
// Chequebook is an auto generated Go binding around an Genom contract.
...
// ChequebookCaller is an auto generated read-only Go binding around an Genom contract.
type ChequebookCaller struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// ChequebookTransactor is an auto generated write-only Go binding around an Genom contract.
type ChequebookTransactor struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// ChequebookFilterer is an auto generated log filtering Go binding around an Genom contract events.
type ChequebookFilterer struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// ChequebookSession is an auto generated Go binding around an Genom contract,
...
// ChequebookCallerSession is an auto generated read-only Go binding around an Genom contract,
...
// ChequebookTransactorSession is an auto generated write-only Go binding around an Genom contract,
...
// ChequebookRaw is an auto generated low-level Go binding around an Genom contract.
type ChequebookRaw struct {
	Contract *Chequebook // Generic contract binding to access the raw methods on
}

// ChequebookCallerRaw is an auto generated low-level read-only Go binding around an Genom contract.
type ChequebookCallerRaw struct {
	Contract *ChequebookCaller // Generic read-only contract binding to access the raw methods on
}

// ChequebookTransactorRaw is an auto generated low-level write-only Go binding around an Genom contract.
