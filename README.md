...
)](https://godoc.org/github.com/merval-project/merval)
...
[Installation Instructions](https://github.com/merval-project/merval/wiki/Building-Ethereum)
on the wiki.
...
[CLI Wiki page](https://github.com/merval-project/merval/wiki/Command-Line-Options)), but we've
 ...
 * Start up Geth's built-in interactive [JavaScript console](https://github.com/merval-project/merval/wiki/JavaScript-Console),
   ...
   as well as Geth's own [management APIs](https://github.com/merval-project/merval/wiki/Management-APIs).
...
[Geth specific APIs](https://github.com/merval-project/merval/wiki/Management-APIs)). These can be
...
Please see the [Developers' Guide](https://github.com/merval-project/merval/wiki/Developers'-Guide)
