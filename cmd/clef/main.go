...
import (
	...
	"github.com/genom-project/genom/signer/core"
	"github.com/genom-project/genom/signer/rules"
	"github.com/genom-project/genom/signer/storage"
...
func init() {
	app.Name = "Clef"
	app.Usage = "Manage Genom account operations"
	app.Flags = []cli.Flag{
		logLevelFlag,
		keystoreFlag,
		configdirFlag,
