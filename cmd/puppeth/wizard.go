...
type wizard struct {
	...
	services map[string][]string   // Genom services known to be running on servers
...
// converts it to an Genom address. If an empty line is entered, the default
// value is returned.
