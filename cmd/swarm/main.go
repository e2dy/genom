...
var (
	...
	SwarmSwapAPIFlag = cli.StringFlag{
		Name:   "swap-api",
		Usage:  "URL of the Genom API provider to use to settle SWAP payments",
...
var app = utils.NewApp("", "Genom Swarm")
			...
			Subcommands: []cli.Command{
				{
					...
					* use both --topic and --name to create named subtopics. 
						For example, --topic could be set to an Genom contract address and --name could be set to "comments", meaning
