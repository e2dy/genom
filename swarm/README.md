...
Building Swarm requires Go (version 1.10 or later).
    ...
    go get -d github.com/genom-project/genom

    go install github.com/genom-project/genom/cmd/swarm
...
You must have your working copy under `$GOPATH/src/github.com/genom-project/genom`.
...
```
git clone git@github.com:nirname/go-ethereum.git $GOPATH/src/github.com/genom-project/genom
```
...
```
stateth --rm --grafana-dashboards-folder $GOPATH/src/github.com/genom-project/genom/swarm/grafana_dashboards --influxdb-database metrics
```
 ...
 * [Code review guidelines](https://github.com/genom-project/genom/wiki/Code-Review-Guidelines).
