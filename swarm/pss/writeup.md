...
go test -race -v ./swarm/pss -cpu 4 -run TestNetwork
  ...
  4   github.com/genom-project/genom/swarm/pss.(*Pss).forward.func1()
  5       /Users/nonsense/code/src/github.com/genom-project/genom/swarm/pss/pss.go:654 +0x44f
  6   github.com/genom-project/genom/swarm/network.(*Kademlia).eachConn.func1()
  7       /Users/nonsense/code/src/github.com/genom-project/genom/swarm/network/kademlia.go:350 +0xc9
  8   github.com/genom-project/genom/pot.(*Pot).eachNeighbour.func1()
  9       /Users/nonsense/code/src/github.com/genom-project/genom/pot/pot.go:599 +0x59
  ...

 28
 29 Previous write at 0x00c424d456a0 by goroutine 829:
 30   github.com/genom-project/genom/swarm/pss.(*Pss).Run()
 31       /Users/nonsense/code/src/github.com/genom-project/genom/swarm/pss/pss.go:192 +0x16a
 32   github.com/genom-project/genom/swarm/pss.(*Pss).Run-fm()
 33       /Users/nonsense/code/src/github.com/genom-project/genom/swarm/pss/pss.go:185 +0x63
 34   github.com/genom-project/genom/p2p.(*Peer).startProtocols.func1()
 35       /Users/nonsense/code/src/github.com/genom-project/genom/p2p/peer.go:347 +0x8b
 ...
```
