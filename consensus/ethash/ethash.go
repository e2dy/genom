...
// all blocks' seal as valid, though they still have to conform to the Genom
// consensus rules.
...
// still have to conform to the Genom consensus rules.
...
// they still have to conform to the Genom consensus rules.
