...
// mapped from textual names used in the tests below to actual Genom private
...
// address retrieves the Genom address of a tester account by label, creating
...
func (ap *testerAccountPool) address(account string) common.Address {
	...
	// Resolve and return the Genom address
...
func TestClique(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			// batch (https://github.com/genom-project/genom/issues/17593). Whilst this
